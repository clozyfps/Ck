...
public class ImpactFramesOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		DisplayFramesProcedure.execute()
			...
			DisplayFrame1Procedure.execute()
			...
			DisplayFrame2Procedure.execute()
			...
			DisplayFrame3Procedure.execute()
			...
			DisplayFrame4Procedure.execute()
			...
			DisplayFrame5Procedure.execute()
			...
			DisplayFrame6Procedure.execute()
			...
			DisplayFrame7Procedure.execute()
			...
			DisplayFrame8Procedure.execute()
			...
			DisplayFrame9Procedure.execute()
			...
			DisplayFrame10Procedure.execute()
			...
			DisplayFrame11Procedure.execute()
			...
			DisplayFrame12Procedure.execute()
			...
			DisplayFrame13Procedure.execute()
			...
			DisplayFrame14Procedure.execute()
			...
			DisplayFrame15Procedure.execute()
			...
			DisplayFrame16Procedure.execute()
			...
			DisplayFrame17Procedure.execute()
			...
			DisplayFrame18Procedure.execute()
			...
			DisplayFrame19Procedure.execute()
			...
			DisplayFrame20Procedure.execute(entity)
			...
			DisplayFrame21Procedure.execute()
			...
			DisplayFrame22Procedure.execute()
			...
			DisplayFrame23Procedure.execute()
			...
			DisplayFrame24Procedure.execute()
			...
			DisplayFrame25Procedure.execute()
			...
			DisplayFrame26Procedure.execute()
			...
			DisplayFrame27Procedure.execute()
			...
			DisplayFrame28Procedure.execute()
			...
			DisplayFrame29Procedure.execute()
			...
			DisplayFrame30Procedure.execute()
			...
			DisplayFrame31Procedure.execute()
