...
public class PhoneGUIScreen extends AbstractContainerScreen<PhoneGUIMenu> {
	...
	public void init() {
		...
		PlayerBounty = new EditBox(this.font, this.leftPos + -59, this.topPos + 47, 120, 20, Component.translatable("gui.craft_kaisen.phone_gui.PlayerBounty")) {
			{
		...
		BountyPlayer = new EditBox(this.font, this.leftPos + -59, this.topPos + 75, 120, 20, Component.translatable("gui.craft_kaisen.phone_gui.BountyPlayer")) {
			{
		...
		button_place = new Button(this.leftPos + -24, this.topPos + 104, 51, 20, Component.translatable("gui.craft_kaisen.phone_gui.button_place"), e -> {
		});
