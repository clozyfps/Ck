...
import net.mcreator.craftkaisen.procedures.InventoryCurseMobRightClickedOnEntityProcedure;
...
public class InventoryCurseMobEntity extends Monster {
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		InventoryCurseMobRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}
