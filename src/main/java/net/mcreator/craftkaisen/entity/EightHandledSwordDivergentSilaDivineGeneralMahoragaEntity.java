...
public class EightHandledSwordDivergentSilaDivineGeneralMahoragaEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(EightHandledSwordDivergentSilaDivineGeneralMahoragaEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(EightHandledSwordDivergentSilaDivineGeneralMahoragaEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(EightHandledSwordDivergentSilaDivineGeneralMahoragaEntity.class, EntityDataSerializers.STRING);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mahoragatexture");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(EightHandledSwordDivergentSilaDivineGeneralMahoragaEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
